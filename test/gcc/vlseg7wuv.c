...
uint16x7xm1_t test_vlseg7wuv_uint16x7xm1 (const unsigned short *address, unsigned int gvl) {
    return vlseg7wuv_uint16x7xm1 (address, gvl);
}
...
uint8x7xm1_t test_vlseg7wuv_uint8x7xm1 (const unsigned char *address, unsigned int gvl) {
    return vlseg7wuv_uint8x7xm1 (address, gvl);
}

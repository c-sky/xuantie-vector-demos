...
uint16x2xm1_t test_vlsseg2wuv_uint16x2xm1 (const unsigned short *address, long stride, unsigned int gvl) {
    return vlsseg2wuv_uint16x2xm1 (address, stride, gvl);
}


uint16x2xm2_t test_vlsseg2wuv_uint16x2xm2 (const unsigned short *address, long stride, unsigned int gvl) {
    return vlsseg2wuv_uint16x2xm2 (address, stride, gvl);
}


uint16x2xm4_t test_vlsseg2wuv_uint16x2xm4 (const unsigned short *address, long stride, unsigned int gvl) {
    return vlsseg2wuv_uint16x2xm4 (address, stride, gvl);
}
...
uint8x2xm1_t test_vlsseg2wuv_uint8x2xm1 (const unsigned char *address, long stride, unsigned int gvl) {
    return vlsseg2wuv_uint8x2xm1 (address, stride, gvl);
}


uint8x2xm2_t test_vlsseg2wuv_uint8x2xm2 (const unsigned char *address, long stride, unsigned int gvl) {
    return vlsseg2wuv_uint8x2xm2 (address, stride, gvl);
}


uint8x2xm4_t test_vlsseg2wuv_uint8x2xm4 (const unsigned char *address, long stride, unsigned int gvl) {
    return vlsseg2wuv_uint8x2xm4 (address, stride, gvl);
}

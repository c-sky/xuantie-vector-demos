...
uint16x3xm1_t test_vlsseg3wuv_mask_uint16x3xm1 (uint16x3xm1_t merge, const unsigned short *address, long stride, e16xm1_t mask, unsigned int gvl) {
    return vlsseg3wuv_mask_uint16x3xm1 (merge, address, stride, mask, gvl);
}


uint16x3xm2_t test_vlsseg3wuv_mask_uint16x3xm2 (uint16x3xm2_t merge, const unsigned short *address, long stride, e16xm2_t mask, unsigned int gvl) {
    return vlsseg3wuv_mask_uint16x3xm2 (merge, address, stride, mask, gvl);
}
...
uint8x3xm1_t test_vlsseg3wuv_mask_uint8x3xm1 (uint8x3xm1_t merge, const unsigned char *address, long stride, e8xm1_t mask, unsigned int gvl) {
    return vlsseg3wuv_mask_uint8x3xm1 (merge, address, stride, mask, gvl);
}


uint8x3xm2_t test_vlsseg3wuv_mask_uint8x3xm2 (uint8x3xm2_t merge, const unsigned char *address, long stride, e8xm2_t mask, unsigned int gvl) {
    return vlsseg3wuv_mask_uint8x3xm2 (merge, address, stride, mask, gvl);
}

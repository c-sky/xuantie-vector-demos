...
uint16x4xm1_t test_vlseg4wuv_uint16x4xm1 (const unsigned short *address, unsigned int gvl) {
    return vlseg4wuv_uint16x4xm1 (address, gvl);
}


uint16x4xm2_t test_vlseg4wuv_uint16x4xm2 (const unsigned short *address, unsigned int gvl) {
    return vlseg4wuv_uint16x4xm2 (address, gvl);
}
...
uint8x4xm1_t test_vlseg4wuv_uint8x4xm1 (const unsigned char *address, unsigned int gvl) {
    return vlseg4wuv_uint8x4xm1 (address, gvl);
}


uint8x4xm2_t test_vlseg4wuv_uint8x4xm2 (const unsigned char *address, unsigned int gvl) {
    return vlseg4wuv_uint8x4xm2 (address, gvl);
}

...
uint8x4xm1_t test_vlseg4huv_uint8x4xm1 (const unsigned char *address, unsigned int gvl) {
    return vlseg4huv_uint8x4xm1 (address, gvl);
}


uint8x4xm2_t test_vlseg4huv_uint8x4xm2 (const unsigned char *address, unsigned int gvl) {
    return vlseg4huv_uint8x4xm2 (address, gvl);
}

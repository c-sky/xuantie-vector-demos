...
uint16x4xm1_t test_vlsseg4wuv_mask_uint16x4xm1 (uint16x4xm1_t merge, const unsigned short *address, long stride, e16xm1_t mask, unsigned int gvl) {
    return vlsseg4wuv_mask_uint16x4xm1 (merge, address, stride, mask, gvl);
}


uint16x4xm2_t test_vlsseg4wuv_mask_uint16x4xm2 (uint16x4xm2_t merge, const unsigned short *address, long stride, e16xm2_t mask, unsigned int gvl) {
    return vlsseg4wuv_mask_uint16x4xm2 (merge, address, stride, mask, gvl);
}
...
uint8x4xm1_t test_vlsseg4wuv_mask_uint8x4xm1 (uint8x4xm1_t merge, const unsigned char *address, long stride, e8xm1_t mask, unsigned int gvl) {
    return vlsseg4wuv_mask_uint8x4xm1 (merge, address, stride, mask, gvl);
}


uint8x4xm2_t test_vlsseg4wuv_mask_uint8x4xm2 (uint8x4xm2_t merge, const unsigned char *address, long stride, e8xm2_t mask, unsigned int gvl) {
    return vlsseg4wuv_mask_uint8x4xm2 (merge, address, stride, mask, gvl);
}

...
uint16x2xm1_t test_vlseg2wuv_uint16x2xm1 (const unsigned short *address, unsigned int gvl) {
    return vlseg2wuv_uint16x2xm1 (address, gvl);
}


uint16x2xm2_t test_vlseg2wuv_uint16x2xm2 (const unsigned short *address, unsigned int gvl) {
    return vlseg2wuv_uint16x2xm2 (address, gvl);
}


uint16x2xm4_t test_vlseg2wuv_uint16x2xm4 (const unsigned short *address, unsigned int gvl) {
    return vlseg2wuv_uint16x2xm4 (address, gvl);
}
...
uint8x2xm1_t test_vlseg2wuv_uint8x2xm1 (const unsigned char *address, unsigned int gvl) {
    return vlseg2wuv_uint8x2xm1 (address, gvl);
}


uint8x2xm2_t test_vlseg2wuv_uint8x2xm2 (const unsigned char *address, unsigned int gvl) {
    return vlseg2wuv_uint8x2xm2 (address, gvl);
}


uint8x2xm4_t test_vlseg2wuv_uint8x2xm4 (const unsigned char *address, unsigned int gvl) {
    return vlseg2wuv_uint8x2xm4 (address, gvl);
}

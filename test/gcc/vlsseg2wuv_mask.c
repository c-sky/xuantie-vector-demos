...
uint16x2xm1_t test_vlsseg2wuv_mask_uint16x2xm1 (uint16x2xm1_t merge, const unsigned short *address, long stride, e16xm1_t mask, unsigned int gvl) {
    return vlsseg2wuv_mask_uint16x2xm1 (merge, address, stride, mask, gvl);
}


uint16x2xm2_t test_vlsseg2wuv_mask_uint16x2xm2 (uint16x2xm2_t merge, const unsigned short *address, long stride, e16xm2_t mask, unsigned int gvl) {
    return vlsseg2wuv_mask_uint16x2xm2 (merge, address, stride, mask, gvl);
}


uint16x2xm4_t test_vlsseg2wuv_mask_uint16x2xm4 (uint16x2xm4_t merge, const unsigned short *address, long stride, e16xm4_t mask, unsigned int gvl) {
    return vlsseg2wuv_mask_uint16x2xm4 (merge, address, stride, mask, gvl);
}
...
uint8x2xm1_t test_vlsseg2wuv_mask_uint8x2xm1 (uint8x2xm1_t merge, const unsigned char *address, long stride, e8xm1_t mask, unsigned int gvl) {
    return vlsseg2wuv_mask_uint8x2xm1 (merge, address, stride, mask, gvl);
}


uint8x2xm2_t test_vlsseg2wuv_mask_uint8x2xm2 (uint8x2xm2_t merge, const unsigned char *address, long stride, e8xm2_t mask, unsigned int gvl) {
    return vlsseg2wuv_mask_uint8x2xm2 (merge, address, stride, mask, gvl);
}


uint8x2xm4_t test_vlsseg2wuv_mask_uint8x2xm4 (uint8x2xm4_t merge, const unsigned char *address, long stride, e8xm4_t mask, unsigned int gvl) {
    return vlsseg2wuv_mask_uint8x2xm4 (merge, address, stride, mask, gvl);
}

...
uint16x6xm1_t test_vlsseg6wuv_mask_uint16x6xm1 (uint16x6xm1_t merge, const unsigned short *address, long stride, e16xm1_t mask, unsigned int gvl) {
    return vlsseg6wuv_mask_uint16x6xm1 (merge, address, stride, mask, gvl);
}
...
uint8x6xm1_t test_vlsseg6wuv_mask_uint8x6xm1 (uint8x6xm1_t merge, const unsigned char *address, long stride, e8xm1_t mask, unsigned int gvl) {
    return vlsseg6wuv_mask_uint8x6xm1 (merge, address, stride, mask, gvl);
}

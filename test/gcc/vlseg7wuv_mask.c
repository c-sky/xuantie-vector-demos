...
uint16x7xm1_t test_vlseg7wuv_mask_uint16x7xm1 (uint16x7xm1_t merge, const unsigned short *address, e16xm1_t mask, unsigned int gvl) {
    return vlseg7wuv_mask_uint16x7xm1 (merge, address, mask, gvl);
}
...
uint8x7xm1_t test_vlseg7wuv_mask_uint8x7xm1 (uint8x7xm1_t merge, const unsigned char *address, e8xm1_t mask, unsigned int gvl) {
    return vlseg7wuv_mask_uint8x7xm1 (merge, address, mask, gvl);
}

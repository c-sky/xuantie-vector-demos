...
uint16x5xm1_t test_vlseg5wuv_uint16x5xm1 (const unsigned short *address, unsigned int gvl) {
    return vlseg5wuv_uint16x5xm1 (address, gvl);
}
...
uint8x5xm1_t test_vlseg5wuv_uint8x5xm1 (const unsigned char *address, unsigned int gvl) {
    return vlseg5wuv_uint8x5xm1 (address, gvl);
}

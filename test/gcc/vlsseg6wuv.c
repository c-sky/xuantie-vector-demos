...
uint16x6xm1_t test_vlsseg6wuv_uint16x6xm1 (const unsigned short *address, long stride, unsigned int gvl) {
    return vlsseg6wuv_uint16x6xm1 (address, stride, gvl);
}
...
uint8x6xm1_t test_vlsseg6wuv_uint8x6xm1 (const unsigned char *address, long stride, unsigned int gvl) {
    return vlsseg6wuv_uint8x6xm1 (address, stride, gvl);
}

...
uint16x3xm1_t test_vlsseg3wuv_uint16x3xm1 (const unsigned short *address, long stride, unsigned int gvl) {
    return vlsseg3wuv_uint16x3xm1 (address, stride, gvl);
}


uint16x3xm2_t test_vlsseg3wuv_uint16x3xm2 (const unsigned short *address, long stride, unsigned int gvl) {
    return vlsseg3wuv_uint16x3xm2 (address, stride, gvl);
}
...
uint8x3xm1_t test_vlsseg3wuv_uint8x3xm1 (const unsigned char *address, long stride, unsigned int gvl) {
    return vlsseg3wuv_uint8x3xm1 (address, stride, gvl);
}


uint8x3xm2_t test_vlsseg3wuv_uint8x3xm2 (const unsigned char *address, long stride, unsigned int gvl) {
    return vlsseg3wuv_uint8x3xm2 (address, stride, gvl);
}

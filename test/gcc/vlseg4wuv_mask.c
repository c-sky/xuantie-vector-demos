...
uint16x4xm1_t test_vlseg4wuv_mask_uint16x4xm1 (uint16x4xm1_t merge, const unsigned short *address, e16xm1_t mask, unsigned int gvl) {
    return vlseg4wuv_mask_uint16x4xm1 (merge, address, mask, gvl);
}


uint16x4xm2_t test_vlseg4wuv_mask_uint16x4xm2 (uint16x4xm2_t merge, const unsigned short *address, e16xm2_t mask, unsigned int gvl) {
    return vlseg4wuv_mask_uint16x4xm2 (merge, address, mask, gvl);
}
...
uint8x4xm1_t test_vlseg4wuv_mask_uint8x4xm1 (uint8x4xm1_t merge, const unsigned char *address, e8xm1_t mask, unsigned int gvl) {
    return vlseg4wuv_mask_uint8x4xm1 (merge, address, mask, gvl);
}


uint8x4xm2_t test_vlseg4wuv_mask_uint8x4xm2 (uint8x4xm2_t merge, const unsigned char *address, e8xm2_t mask, unsigned int gvl) {
    return vlseg4wuv_mask_uint8x4xm2 (merge, address, mask, gvl);
}

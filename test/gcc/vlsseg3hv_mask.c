...
int8x3xm1_t test_vlsseg3hv_mask_int8x3xm1 (int8x3xm1_t merge, const signed char *address, long stride, e8xm1_t mask, unsigned int gvl) {
    return vlsseg3hv_mask_int8x3xm1 (merge, address, stride, mask, gvl);
}


int8x3xm2_t test_vlsseg3hv_mask_int8x3xm2 (int8x3xm2_t merge, const signed char *address, long stride, e8xm2_t mask, unsigned int gvl) {
    return vlsseg3hv_mask_int8x3xm2 (merge, address, stride, mask, gvl);
}

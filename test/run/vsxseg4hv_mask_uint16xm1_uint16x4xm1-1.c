...
int main(int argc, char **argv) {
	...
	uint16x4xm1_t *a1 = (uint16x4xm1_t *)input1;
	uint16x4xm1_t *a2 = (uint16x4xm1_t *)input2;
	...
	unsigned short int *aa;
		...
		vsxseg4hv_mask_uint16xm1_uint16x4xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg4huv_mask_uint16x4xm1_uint16xm1(*a1, address, *a7, a3, gvl);

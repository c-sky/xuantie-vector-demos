...
int main(int argc, char **argv) {
	...
	int32x4xm2_t *a1 = (int32x4xm2_t *)input1;
	int32x4xm2_t *a2 = (int32x4xm2_t *)input2;
	int32xm2_t *a7 = (int32xm2_t *)stride;
	...
	int *aa;
		...
		vsxseg4ev_mask_int32xm2_int32x4xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg4ev_mask_int32x4xm2_int32xm2(*a1, address, *a7, a3, gvl);
		aa = (int *) &bb.v.val[0];

...
int main(int argc, char **argv) {
	...
	int16x6xm1_t *a2 = (int16x6xm1_t *)input2;
	...
	short int *aa;
		...
		vsxseg6bv_mask_int16xm1_int16x6xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg6bv_mask_int16x6xm1_int16xm1(*a1, address, *a7, a3, gvl);

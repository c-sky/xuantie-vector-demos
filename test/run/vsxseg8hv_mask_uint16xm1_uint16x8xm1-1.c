...
int main(int argc, char **argv) {
	...
	int nf=8;
        ...
        unsigned short int input1[8*vlmax];
        unsigned short int input2[8*vlmax];
        unsigned short int input3[8*vlmax];
	...
	uint16x8xm1_t *a1 = (uint16x8xm1_t *)input1;
	uint16x8xm1_t *a2 = (uint16x8xm1_t *)input2;
	...
	unsigned short int *aa;
		...
		vsxseg8hv_mask_uint16xm1_uint16x8xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg8huv_mask_uint16x8xm1_uint16xm1(*a1, address, *a7, a3, gvl);

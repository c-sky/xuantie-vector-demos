...
int main(int argc, char **argv) {
	...
	int8x4xm1_t *a1 = (int8x4xm1_t *)input1;
	int8x4xm1_t *a2 = (int8x4xm1_t *)input2;
	...
	signed char *aa;
		...
		vsxseg4ev_mask_int8xm1_int8x4xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg4ev_mask_int8x4xm1_int8xm1(*a1, address, *a7, a3, gvl);

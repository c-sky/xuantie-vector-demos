...
int main(int argc, char **argv) {
	...
	int32x4xm1_t *a1 = (int32x4xm1_t *)input1;
	int32x4xm1_t *a2 = (int32x4xm1_t *)input2;
	...
	int *aa;
		...
		vsxseg4bv_mask_int32xm1_int32x4xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg4bv_mask_int32x4xm1_int32xm1(*a1, address, *a7, a3, gvl);
		aa = (int *) &bb.v.val[0];

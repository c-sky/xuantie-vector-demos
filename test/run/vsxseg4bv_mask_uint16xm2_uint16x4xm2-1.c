...
int main(int argc, char **argv) {
	...
	int nf=4;
        ...
        unsigned short int input1[4*vlmax];
        unsigned short int input2[4*vlmax];
        unsigned short int input3[4*vlmax];
	...
	uint16x4xm2_t *a1 = (uint16x4xm2_t *)input1;
	uint16x4xm2_t *a2 = (uint16x4xm2_t *)input2;
	...
	unsigned short int *aa;
		...
		vsxseg4bv_mask_uint16xm2_uint16x4xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg4buv_mask_uint16x4xm2_uint16xm2(*a1, address, *a7, a3, gvl);

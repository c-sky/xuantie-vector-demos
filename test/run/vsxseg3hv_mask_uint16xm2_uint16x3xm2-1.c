...
int main(int argc, char **argv) {
	...
	uint16x3xm2_t *a1 = (uint16x3xm2_t *)input1;
	uint16x3xm2_t *a2 = (uint16x3xm2_t *)input2;
	...
	unsigned short int *aa;
		...
		vsxseg3hv_mask_uint16xm2_uint16x3xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg3huv_mask_uint16x3xm2_uint16xm2(*a1, address, *a7, a3, gvl);

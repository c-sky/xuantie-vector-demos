...
int main(int argc, char **argv) {
	...
	int nf=3;
        ...
        unsigned int input1[3*vlmax];
        unsigned int input2[3*vlmax];
        unsigned int input3[3*vlmax];
        unsigned int expect;
        uint32x3xm1_t bb;
        int rte = 0;
        int gvl=0;
	...
	uint32x3xm1_t *a1 = (uint32x3xm1_t *)input1;
	uint32x3xm1_t *a2 = (uint32x3xm1_t *)input2;
	...
	unsigned int *aa;
		...
		vsxseg3bv_mask_uint32xm1_uint32x3xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg3buv_mask_uint32x3xm1_uint32xm1(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	int16x7xm1_t *a1 = (int16x7xm1_t *)input1;
	int16x7xm1_t *a2 = (int16x7xm1_t *)input2;
	...
	short int *aa;
		...
		vsxseg7hv_mask_int16xm1_int16x7xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg7hv_mask_int16x7xm1_int16xm1(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	int nf=8;
        ...
        unsigned long long input1[8*vlmax];
        unsigned long long input2[8*vlmax];
        unsigned long long input3[8*vlmax];
	...
	unsigned long long *aa;
		...
		vsxseg8bv_mask_uint64xm1_uint64x8xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg8buv_mask_uint64x8xm1_uint64xm1(*a1, address, *a7, a3, gvl);

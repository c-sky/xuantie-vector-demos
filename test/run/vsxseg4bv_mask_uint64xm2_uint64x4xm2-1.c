...
int main(int argc, char **argv) {
	...
	uint64x4xm2_t *a2 = (uint64x4xm2_t *)input2;
	...
	unsigned long long *aa;
		...
		vsxseg4bv_mask_uint64xm2_uint64x4xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg4buv_mask_uint64x4xm2_uint64xm2(*a1, address, *a7, a3, gvl);

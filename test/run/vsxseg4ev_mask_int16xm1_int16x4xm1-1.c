...
int main(int argc, char **argv) {
	...
	int16x4xm1_t *a1 = (int16x4xm1_t *)input1;
	int16x4xm1_t *a2 = (int16x4xm1_t *)input2;
	...
	short int *aa;
		...
		vsxseg4ev_mask_int16xm1_int16x4xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg4ev_mask_int16x4xm1_int16xm1(*a1, address, *a7, a3, gvl);

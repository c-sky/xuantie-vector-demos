...
int main(int argc, char **argv) {
	...
	int nf=4;
        ...
        unsigned long long input2[4*vlmax];
	...
	uint64x4xm1_t *a2 = (uint64x4xm1_t *)input2;
	...
	unsigned long long *aa;
		...
		vsxseg4bv_mask_uint64xm1_uint64x4xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg4buv_mask_uint64x4xm1_uint64xm1(*a1, address, *a7, a3, gvl);

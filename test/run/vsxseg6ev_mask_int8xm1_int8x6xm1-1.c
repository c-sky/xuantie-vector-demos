...
int main(int argc, char **argv) {
	...
	int nf=6;
        ...
        signed char input1[6*vlmax];
        signed char input2[6*vlmax];
        signed char input3[6*vlmax];
        signed char expect;
        int8x6xm1_t bb;
        int rte = 0;
        int gvl=0;
	...
	int8x6xm1_t *a1 = (int8x6xm1_t *)input1;
	int8x6xm1_t *a2 = (int8x6xm1_t *)input2;
	...
	signed char *aa;
		...
		vsxseg6ev_mask_int8xm1_int8x6xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg6ev_mask_int8x6xm1_int8xm1(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	uint32x4xm2_t *a1 = (uint32x4xm2_t *)input1;
	uint32x4xm2_t *a2 = (uint32x4xm2_t *)input2;
	...
	unsigned int *aa;
		...
		vsxseg4wv_mask_uint32xm2_uint32x4xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg4wuv_mask_uint32x4xm2_uint32xm2(*a1, address, *a7, a3, gvl);

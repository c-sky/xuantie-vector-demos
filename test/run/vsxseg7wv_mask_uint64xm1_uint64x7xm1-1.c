...
int main(int argc, char **argv) {
	...
	int nf=7;
        ...
        unsigned long long input2[7*vlmax];
        unsigned long long input3[7*vlmax];
	...
	uint64x7xm1_t *a2 = (uint64x7xm1_t *)input2;
	...
	unsigned long long *aa;
		...
		vsxseg7wv_mask_uint64xm1_uint64x7xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg7wuv_mask_uint64x7xm1_uint64xm1(*a1, address, *a7, a3, gvl);

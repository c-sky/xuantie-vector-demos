...
int main(int argc, char **argv) {
	...
	int16x5xm1_t *a2 = (int16x5xm1_t *)input2;
	...
	short int *aa;
		...
		vsxseg5bv_mask_int16xm1_int16x5xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg5bv_mask_int16x5xm1_int16xm1(*a1, address, *a7, a3, gvl);

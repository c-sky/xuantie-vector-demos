...
int main(int argc, char **argv) {
	...
	int16x3xm2_t *a1 = (int16x3xm2_t *)input1;
	int16x3xm2_t *a2 = (int16x3xm2_t *)input2;
	...
	short int *aa;
		...
		vsxseg3ev_mask_int16xm2_int16x3xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg3ev_mask_int16x3xm2_int16xm2(*a1, address, *a7, a3, gvl);

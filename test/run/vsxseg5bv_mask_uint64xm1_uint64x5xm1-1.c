...
int main(int argc, char **argv) {
	...
	int nf=5;
        ...
        unsigned long long input1[5*vlmax];
        unsigned long long input2[5*vlmax];
        unsigned long long input3[5*vlmax];
	...
	uint64x5xm1_t *a1 = (uint64x5xm1_t *)input1;
	uint64x5xm1_t *a2 = (uint64x5xm1_t *)input2;
	...
	unsigned long long *aa;
		...
		vsxseg5bv_mask_uint64xm1_uint64x5xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg5buv_mask_uint64x5xm1_uint64xm1(*a1, address, *a7, a3, gvl);

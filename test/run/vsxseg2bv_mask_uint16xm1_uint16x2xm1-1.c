...
int main(int argc, char **argv) {
	...
	int nf=2;
        ...
        unsigned short int input1[2*vlmax];
        unsigned short int input2[2*vlmax];
        unsigned short int input3[2*vlmax];
	...
	uint16x2xm1_t *a1 = (uint16x2xm1_t *)input1;
	uint16x2xm1_t *a2 = (uint16x2xm1_t *)input2;
	...
	unsigned short int *aa;
		...
		vsxseg2bv_mask_uint16xm1_uint16x2xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg2buv_mask_uint16x2xm1_uint16xm1(*a1, address, *a7, a3, gvl);

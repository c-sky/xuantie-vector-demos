...
int main(int argc, char **argv) {
	...
	int nf=5;
        ...
        unsigned short int input1[5*vlmax];
        unsigned short int input2[5*vlmax];
        unsigned short int input3[5*vlmax];
	...
	unsigned short int *aa;
		...
		vsxseg5bv_mask_uint16xm1_uint16x5xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg5buv_mask_uint16x5xm1_uint16xm1(*a1, address, *a7, a3, gvl);

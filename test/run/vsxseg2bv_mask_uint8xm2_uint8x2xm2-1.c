...
int main(int argc, char **argv) {
	...
	uint8x2xm2_t *a2 = (uint8x2xm2_t *)input2;
	uint8xm2_t *a7 = (uint8xm2_t *)stride;
	...
	unsigned char *aa;
		...
		vsxseg2bv_mask_uint8xm2_uint8x2xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg2buv_mask_uint8x2xm2_uint8xm2(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	uint32x2xm2_t *a1 = (uint32x2xm2_t *)input1;
	uint32x2xm2_t *a2 = (uint32x2xm2_t *)input2;
	...
	unsigned int *aa;
		...
		vsxseg2wv_mask_uint32xm2_uint32x2xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg2wuv_mask_uint32x2xm2_uint32xm2(*a1, address, *a7, a3, gvl);

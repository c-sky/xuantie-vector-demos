...
int main(int argc, char **argv) {
	...
	uint8x6xm1_t *a2 = (uint8x6xm1_t *)input2;
	...
	unsigned char *aa;
		...
		vsxseg6bv_mask_uint8xm1_uint8x6xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg6buv_mask_uint8x6xm1_uint8xm1(*a1, address, *a7, a3, gvl);

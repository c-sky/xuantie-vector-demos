...
int main(int argc, char **argv) {
	...
	int32x2xm2_t *a1 = (int32x2xm2_t *)input1;
	int32x2xm2_t *a2 = (int32x2xm2_t *)input2;
	...
	int *aa;
		...
		vsxseg2bv_mask_int32xm2_int32x2xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg2bv_mask_int32x2xm2_int32xm2(*a1, address, *a7, a3, gvl);
		aa = (int *) &bb.v.val[0];

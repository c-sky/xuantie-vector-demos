...
int main(int argc, char **argv) {
	...
	int nf=3;
        ...
        short int input1[3*vlmax];
        short int input2[3*vlmax];
        short int input3[3*vlmax];
        short int expect;
        int16x3xm1_t bb;
        int rte = 0;
        int gvl=0;
	...
	int16x3xm1_t *a1 = (int16x3xm1_t *)input1;
	int16x3xm1_t *a2 = (int16x3xm1_t *)input2;
	...
	short int *aa;
		...
		vsxseg3ev_mask_int16xm1_int16x3xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg3ev_mask_int16x3xm1_int16xm1(*a1, address, *a7, a3, gvl);

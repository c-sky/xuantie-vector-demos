...
int main(int argc, char **argv) {
	...
	int nf=7;
        ...
        signed char input1[7*vlmax];
        signed char input2[7*vlmax];
        signed char input3[7*vlmax];
        signed char expect;
        int8x7xm1_t bb;
        int rte = 0;
        int gvl=0;
	...
	int8x7xm1_t *a1 = (int8x7xm1_t *)input1;
	int8x7xm1_t *a2 = (int8x7xm1_t *)input2;
	...
	signed char *aa;
		...
		vsxseg7bv_mask_int8xm1_int8x7xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg7bv_mask_int8x7xm1_int8xm1(*a1, address, *a7, a3, gvl);

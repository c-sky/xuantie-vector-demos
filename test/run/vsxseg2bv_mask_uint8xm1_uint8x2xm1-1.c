...
int main(int argc, char **argv) {
	...
	int nf=2;
        ...
        unsigned char input2[2*vlmax];
        unsigned char input3[2*vlmax];
	...
	uint8x2xm1_t *a1 = (uint8x2xm1_t *)input1;
	uint8x2xm1_t *a2 = (uint8x2xm1_t *)input2;
	...
	unsigned char *aa;
		...
		vsxseg2bv_mask_uint8xm1_uint8x2xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg2buv_mask_uint8x2xm1_uint8xm1(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	int64x8xm1_t *a2 = (int64x8xm1_t *)input2;
	...
	long long *aa;
		...
		vsxseg8ev_mask_int64xm1_int64x8xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg8ev_mask_int64x8xm1_int64xm1(*a1, address, *a7, a3, gvl);

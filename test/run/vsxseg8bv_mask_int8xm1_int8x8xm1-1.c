...
int main(int argc, char **argv) {
	...
	int nf=8;
        ...
        signed char input1[8*vlmax];
        signed char input2[8*vlmax];
        signed char input3[8*vlmax];
        signed char expect;
        int8x8xm1_t bb;
        int rte = 0;
        int gvl=0;
	...
	int8x8xm1_t *a1 = (int8x8xm1_t *)input1;
	int8x8xm1_t *a2 = (int8x8xm1_t *)input2;
	...
	signed char *aa;
		...
		vsxseg8bv_mask_int8xm1_int8x8xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg8bv_mask_int8x8xm1_int8xm1(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	uint32x4xm1_t *a2 = (uint32x4xm1_t *)input2;
	...
	unsigned int *aa;
		...
		vsxseg4bv_mask_uint32xm1_uint32x4xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg4buv_mask_uint32x4xm1_uint32xm1(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	int32x3xm1_t *a1 = (int32x3xm1_t *)input1;
	int32x3xm1_t *a2 = (int32x3xm1_t *)input2;
	...
	int *aa;
		...
		vsxseg3bv_mask_int32xm1_int32x3xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg3bv_mask_int32x3xm1_int32xm1(*a1, address, *a7, a3, gvl);
		aa = (int *) &bb.v.val[0];

...
int main(int argc, char **argv) {
	...
	int16x2xm1_t *a1 = (int16x2xm1_t *)input1;
	int16x2xm1_t *a2 = (int16x2xm1_t *)input2;
	int16xm1_t *a7 = (int16xm1_t *)stride;
	...
	short int *aa;
		...
		vsxseg2ev_mask_int16xm1_int16x2xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg2ev_mask_int16x2xm1_int16xm1(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
        ...
        float input1[5*vlmax];
        float input2[5*vlmax];
	int input3[5*vlmax];
        float expect;
        float32x5xm1_t bb;
        int rte = 0;
	...
	e32xm1_t a3;
		...
		a3 = vmsnevi_e32xm1_int32xm1(*a8, 0, gvl);
                vsxseg5ev_mask_float32xm1_float32x5xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg5ev_mask_float32x5xm1_float32xm1(*a1, address, *a7,  a3, gvl);
                aa = (float *) &bb.v.val[0];

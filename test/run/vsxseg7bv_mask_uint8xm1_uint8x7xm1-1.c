...
int main(int argc, char **argv) {
	...
	int nf=7;
        ...
        unsigned char input1[7*vlmax];
        unsigned char input2[7*vlmax];
        unsigned char input3[7*vlmax];
	...
	uint8x7xm1_t *a1 = (uint8x7xm1_t *)input1;
	uint8x7xm1_t *a2 = (uint8x7xm1_t *)input2;
	...
	unsigned char *aa;
		...
		vsxseg7bv_mask_uint8xm1_uint8x7xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg7buv_mask_uint8x7xm1_uint8xm1(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	int nf=4;
        ...
        signed char input1[4*vlmax];
        signed char input2[4*vlmax];
        signed char input3[4*vlmax];
        signed char expect;
        int8x4xm2_t bb;
        int rte = 0;
        int gvl=0;
	...
	signed char *aa;
		...
		vsxseg4bv_mask_int8xm2_int8x4xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg4bv_mask_int8x4xm2_int8xm2(*a1, address, *a7, a3, gvl);

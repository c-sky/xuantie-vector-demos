...
int main(int argc, char **argv) {
	...
	uint64x2xm1_t *a1 = (uint64x2xm1_t *)input1;
	uint64x2xm1_t *a2 = (uint64x2xm1_t *)input2;
	...
	unsigned long long *aa;
		...
		vsxseg2hv_mask_uint64xm1_uint64x2xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg2huv_mask_uint64x2xm1_uint64xm1(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	int nf=2;
        ...
        unsigned int input1[2*vlmax];
        unsigned int input2[2*vlmax];
        unsigned int input3[2*vlmax];
        unsigned int expect;
        uint32x2xm1_t bb;
        int rte = 0;
        int gvl=0;
	...
	unsigned int *aa;
		...
		vsxseg2bv_mask_uint32xm1_uint32x2xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg2buv_mask_uint32x2xm1_uint32xm1(*a1, address, *a7, a3, gvl);

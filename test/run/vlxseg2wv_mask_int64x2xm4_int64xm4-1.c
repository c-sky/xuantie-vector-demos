...
// trans input to stride 
	...
	int64x2xm4_t *a0 = (int64x2xm4_t *)input1;
        const long long *a1 = (const long long *)input0;
        int64xm4_t *a7 = (int64xm4_t *)strid;
	int64xm4_t *a8 = (int64xm4_t *)input3;
	e64xm4_t a3;
	long long *aa;

        for(int t=0; t<N; t++) {
                gvl = vsetvli(avl[t], RVV_E64, RVV_M4);
		a3 = vmsnevi_e64xm4_int64xm4(*a8, 0, gvl);
                bb=vlxseg2wv_mask_int64x2xm4_int64xm4(*a0, a1, *a7, a3, gvl);

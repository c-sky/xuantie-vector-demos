...
int main(int argc, char **argv) {
	...
	int nf=7;
        ...
        unsigned short int input2[7*vlmax];
	...
	uint16x7xm1_t *a2 = (uint16x7xm1_t *)input2;
	...
	unsigned short int *aa;
		...
		vsxseg7hv_mask_uint16xm1_uint16x7xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg7huv_mask_uint16x7xm1_uint16xm1(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	uint32x3xm2_t *a1 = (uint32x3xm2_t *)input1;
	uint32x3xm2_t *a2 = (uint32x3xm2_t *)input2;
	...
	unsigned int *aa;
		...
		vsxseg3bv_mask_uint32xm2_uint32x3xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg3buv_mask_uint32x3xm2_uint32xm2(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	int nf=8;
        ...
        unsigned int input1[8*vlmax];
        unsigned int input2[8*vlmax];
        unsigned int input3[8*vlmax];
        unsigned int expect;
        uint32x8xm1_t bb;
        int rte = 0;
        int gvl=0;
	...
	uint32x8xm1_t *a1 = (uint32x8xm1_t *)input1;
	uint32x8xm1_t *a2 = (uint32x8xm1_t *)input2;
	...
	unsigned int *aa;
		...
		vsxseg8hv_mask_uint32xm1_uint32x8xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg8huv_mask_uint32x8xm1_uint32xm1(*a1, address, *a7, a3, gvl);

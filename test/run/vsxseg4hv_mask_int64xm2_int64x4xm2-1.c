...
int main(int argc, char **argv) {
	...
	int64x4xm2_t *a1 = (int64x4xm2_t *)input1;
	int64x4xm2_t *a2 = (int64x4xm2_t *)input2;
	...
	long long *aa;
		...
		vsxseg4hv_mask_int64xm2_int64x4xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg4hv_mask_int64x4xm2_int64xm2(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	uint8x4xm2_t *a1 = (uint8x4xm2_t *)input1;
	uint8x4xm2_t *a2 = (uint8x4xm2_t *)input2;
	...
	unsigned char *aa;
		...
		vsxseg4bv_mask_uint8xm2_uint8x4xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg4buv_mask_uint8x4xm2_uint8xm2(*a1, address, *a7, a3, gvl);

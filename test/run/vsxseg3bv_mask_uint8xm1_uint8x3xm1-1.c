...
int main(int argc, char **argv) {
	...
	uint8x3xm1_t *a1 = (uint8x3xm1_t *)input1;
	uint8x3xm1_t *a2 = (uint8x3xm1_t *)input2;
	...
	unsigned char *aa;
		...
		vsxseg3bv_mask_uint8xm1_uint8x3xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg3buv_mask_uint8x3xm1_uint8xm1(*a1, address, *a7, a3, gvl);

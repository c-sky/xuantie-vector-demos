...
int main(int argc, char **argv) {
	...
	int nf=7;
        ...
        long long input1[7*vlmax];
        long long input2[7*vlmax];
	...
	int64x7xm1_t *a1 = (int64x7xm1_t *)input1;
	int64x7xm1_t *a2 = (int64x7xm1_t *)input2;
	int64xm1_t *a7 = (int64xm1_t *)stride;
	...
	long long *aa;
		...
		vsxseg7bv_mask_int64xm1_int64x7xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg7bv_mask_int64x7xm1_int64xm1(*a1, address, *a7, a3, gvl);

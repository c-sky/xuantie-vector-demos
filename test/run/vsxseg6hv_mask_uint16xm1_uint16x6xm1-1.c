...
int main(int argc, char **argv) {
	...
	int nf=6;
        ...
        unsigned short int input2[6*vlmax];
        unsigned short int input3[6*vlmax];
	...
	uint16x6xm1_t *a2 = (uint16x6xm1_t *)input2;
	...
	unsigned short int *aa;
		...
		vsxseg6hv_mask_uint16xm1_uint16x6xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg6huv_mask_uint16x6xm1_uint16xm1(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	int nf=5;
        ...
        unsigned char input1[5*vlmax];
        unsigned char input2[5*vlmax];
        unsigned char input3[5*vlmax];
	...
	uint8x5xm1_t *a1 = (uint8x5xm1_t *)input1;
	uint8x5xm1_t *a2 = (uint8x5xm1_t *)input2;
	...
	unsigned char *aa;
		...
		vsxseg5bv_mask_uint8xm1_uint8x5xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg5buv_mask_uint8x5xm1_uint8xm1(*a1, address, *a7, a3, gvl);

...
int main(int argc, char **argv) {
	...
	int nf=2;
        ...
        short int input1[2*vlmax];
        short int input2[2*vlmax];
        short int input3[2*vlmax];
        short int expect;
        int16x2xm2_t bb;
        int rte = 0;
        int gvl=0;
	...
	int16x2xm2_t *a1 = (int16x2xm2_t *)input1;
	int16x2xm2_t *a2 = (int16x2xm2_t *)input2;
	int16xm2_t *a7 = (int16xm2_t *)stride;
	...
	short int *aa;
		...
		vsxseg2ev_mask_int16xm2_int16x2xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg2ev_mask_int16x2xm2_int16xm2(*a1, address, *a7, a3, gvl);

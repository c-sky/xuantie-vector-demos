...
int main(int argc, char **argv) {
	...
	int nf=7;
        ...
        unsigned int input1[7*vlmax];
        unsigned int input2[7*vlmax];
        unsigned int input3[7*vlmax];
        unsigned int expect;
        uint32x7xm1_t bb;
        int rte = 0;
        int gvl=0;
	...
	uint32x7xm1_t *a1 = (uint32x7xm1_t *)input1;
	uint32x7xm1_t *a2 = (uint32x7xm1_t *)input2;
	...
	unsigned int *aa;
		...
		vsxseg7wv_mask_uint32xm1_uint32x7xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg7wuv_mask_uint32x7xm1_uint32xm1(*a1, address, *a7, a3, gvl);

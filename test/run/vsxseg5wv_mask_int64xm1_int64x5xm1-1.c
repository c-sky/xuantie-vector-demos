...
int main(int argc, char **argv) {
	...
	int nf=5;
        ...
        long long input1[5*vlmax];
        long long input2[5*vlmax];
	...
	int64x5xm1_t *a1 = (int64x5xm1_t *)input1;
	int64x5xm1_t *a2 = (int64x5xm1_t *)input2;
	...
	long long *aa;
		...
		vsxseg5wv_mask_int64xm1_int64x5xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg5wv_mask_int64x5xm1_int64xm1(*a1, address, *a7, a3, gvl);

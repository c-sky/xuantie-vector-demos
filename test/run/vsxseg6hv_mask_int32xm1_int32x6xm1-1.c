...
int main(int argc, char **argv) {
	...
	int32x6xm1_t *a1 = (int32x6xm1_t *)input1;
	int32x6xm1_t *a2 = (int32x6xm1_t *)input2;
	...
	int *aa;
		...
		vsxseg6hv_mask_int32xm1_int32x6xm1(address, *a7, *a2, a3, gvl);
                bb=vlxseg6hv_mask_int32x6xm1_int32xm1(*a1, address, *a7, a3, gvl);
		aa = (int *) &bb.v.val[0];

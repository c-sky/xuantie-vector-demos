...
int main(int argc, char **argv) {
	...
	unsigned long long input3[vlmax];
        ...
        uint64xm8_t *a1 = (uint64xm8_t *)input1;
	const unsigned long long *a2 = (const unsigned long long *)input2;
	uint64xm8_t *a8 = (uint64xm8_t *)input3;
	e64xm8_t a3;

        for(int t=0; t<N; t++) {
                gvl = vsetvli(avl[t], RVV_E64, RVV_M8);
		a3 = vmsnevi_e64xm8_uint64xm8(*a8, 0, gvl);
                bb=vlhuv_mask_uint64xm8(*a1, a2, a3, gvl);

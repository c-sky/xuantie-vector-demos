...
int main(int argc, char **argv) {
	...
	int nf=2;
        ...
        unsigned long long input1[2*vlmax];
        unsigned long long input2[2*vlmax];
        unsigned long long input3[2*vlmax];
	...
	uint64x2xm2_t *a1 = (uint64x2xm2_t *)input1;
	uint64x2xm2_t *a2 = (uint64x2xm2_t *)input2;
	...
	unsigned long long *aa;
		...
		vsxseg2wv_mask_uint64xm2_uint64x2xm2(address, *a7, *a2, a3, gvl);
                bb=vlxseg2wuv_mask_uint64x2xm2_uint64xm2(*a1, address, *a7, a3, gvl);

...
// trans input to stride 
	...
	int64xm8_t *a0 = (int64xm8_t *)input1;
        const long long *a1 = (const long long *)input0;
        int64xm8_t *a7 = (int64xm8_t *)strid;
	int64xm8_t *a8 = (int64xm8_t *)input3;
	e64xm8_t a3;

        for(int t=0; t<N; t++) {
                gvl = vsetvli(avl[t], RVV_E64, RVV_M8);
		a3 = vmsnevi_e64xm8_int64xm8(*a8, 0, gvl);
                bb=vlxwv_mask_int64xm8(*a0, a1, *a7, a3, gvl);
